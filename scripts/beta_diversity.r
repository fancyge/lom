...
var_exp <- round(pcoa_res_comp$values$Relative_eig[1:2] * 100, 1) 
...
##################################################################
abun_func <- read.delim("./inputs/func_plsda.txt",header=T) # batch-corrected

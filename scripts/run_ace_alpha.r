...
#########################################################################
## function 1: run ACE model on each timepoint
#########################################################################
...
comp_T1 <- run_ace_timepoint(shannon, "T1", "shannon_composition") #shannon_pwy_stratified_filtered; # shannon_pwy_unstratified_noun
